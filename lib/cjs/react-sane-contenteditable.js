...
function (_Component) {
  ...
  function ContentEditable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setCaret", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "_onChange", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_onPaste", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_onBlur", function (ev) {
      var sanitise = _this.props.sanitise;
      var rawValue = _this._element.innerText;
    ...
    _defineProperty(_assertThisInitialized(_this), "_onKeyUp", function (ev) {
