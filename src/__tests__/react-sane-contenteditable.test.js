...
describe("Default behaviour", () => {
  ...
  it("onInput sets state.value", () => {
    ...
    const wrapper = mount(
      <ContentEditable content="foo" onChange={mockHandler} />
    );
...
describe("Handles props", () => {
  ...
  it("shouldComponentUpdate returns false when props are the same", () => {
    ...
    const shouldUpdate = wrapper
      .instance()
      .shouldComponentUpdate(wrapper.props());
  ...
  xdescribe("Failing tests to fix in component", () => {
    it("renders the props.content respecting maxLength={5}", () => {
      ...
      const wrapper = shallow(
        <ContentEditable content={content} maxLength={5} />
      );
...
describe("Sanitisation", () => {
  ...
  it("value trimmed when maxLength exceeded", () => {
    ...
    const content = "foo";
    const wrapper = mount(
      <ContentEditable content={content} maxLength={maxLength} />
    );
  ...
  describe("with props.multiLine", () => {
    it("limits consecutive line terminator characters to a maximum of 2", () => {
      const mockHandler = jest.fn();
      const wrapper = mount(
        <ContentEditable multiLine content="foo" onChange={mockHandler} />
      );
    ...
    it("replaces ASCII spaces and feeds", () => {
      ...
      wrapper.instance()._element.innerText =
        "foo\f\f bar\r\r baz\t\t qux\v\v quux";
      focusThenBlur(wrapper);
    ...
    xdescribe("Failing tests to fix in component", () => {
      ...
      it("protects against XSS input", () => {
        ...
        const content = "foo";
        const wrapper = mount(
          <ContentEditable content={content} onChange={mockHandler} />
        );
...
describe("Calls handlers", () => {
  ...
  it("props.onBlur called", () => {
    ...
    const content = "foo";
    const wrapper = mount(
      <ContentEditable content={content} onBlur={mockHandler} />
    );
  ...
  it("props.onKeyDown called", () => {
    ...
    const content = "foo";
    const wrapper = mount(
      <ContentEditable content={content} onKeyDown={mockHandler} />
    );
    const dom = wrapper.instance()._element;
  ...
  it("keydown event.preventDefault called when maxLength exceeded", () => {
    ...
    const content = "foo b";
    const wrapper = mount(
      <ContentEditable content={content} maxLength={content.length} />
    );
    const dom = wrapper.instance()._element;
  ...
  it("props.onChange not called when maxLength exceeded", () => {
    const mockHandler = jest.fn();
    const wrapper = mount(
      <ContentEditable content="foo" maxLength={3} onChange={mockHandler} />
    );
  ...
  it("props.onPaste called", () => {
    ...
    const wrapper = mount(
      <ContentEditable content="foo" onPaste={mockOnPaste} />
    );
    const nextInput = "foo bar";
    ...
    wrapper
      .find("div")
      .simulate("paste", { clipboardData: { getData: mockGetClipboardData } });
